...
RSpec.describe Vehicle, type: :model do
    describe '#valid?' do
        ...
        context 'uniqueness' do
            it  'false when license_plate is already is use' do
                ...
                transportation_modal = TransportationModal.create!(name: 'Bicicleta', max_distance: 10 , min_distance: 1,
                    max_weight: 8, min_weight: 0, flat_rate: 5, status: :active)
                vehicle2 = Vehicle.create!(license_plate: 'HUIK-5232', model: 'City Tour', brand: 'Caloi', max_weight: '5', 
                    manufacture_year: '2015', transportation_modal:transportation_modal, status: :working)
                vehicle = Vehicle.new(license_plate: 'HUIK-5232', model: 'Speed Track', brand: 'Caloi', max_weight: 7, 
        ...
        context 'numeracality' do
            it  'false when manufacture year is future' do
                ...
                transportation_modal = TransportationModal.create!(name: 'Bicicleta', max_distance: 10 , min_distance: 1,
                    max_weight: 8, min_weight: 0, flat_rate: 5, status: :active)
                vehicle = Vehicle.new(license_plate: 'HUIK-5232', model: 'City Tour', brand: 'Caloi', max_weight: '5', 
                    manufacture_year: 1.year.from_now.year, transportation_modal:transportation_modal, status: :working)
    ...
    describe '#set_max_weight' do
        it 'vehicle max_weight is lower or equal to its transportation modal max_weight on create' do
            ...
            transportation_modal = TransportationModal.create!(name: 'Bicicleta', max_distance: 10 , min_distance: 1,
                max_weight: 8, min_weight: 0, flat_rate: 5, status: :active)
            vehicle = Vehicle.new(license_plate: 'HUIK-5232', model: 'City Tour', brand: 'Caloi', max_weight: 10, 
                manufacture_year: 2015, transportation_modal:transportation_modal, status: :working)
