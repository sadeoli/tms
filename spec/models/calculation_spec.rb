...
RSpec.describe Calculation, type: :model do
    context 'weight_cost' do
        it 'return unit_price when weight cost meets the service order' do
            ...
            calculation = Calculation.create!(transportation_modal:transportation_modal, service_order: service_order)
        ...
        it 'return nil when weight cost does not meet the service order' do
            ...
            recipient_name: 'Maria Carvalho', recipient_address: 'Rua das Laranjeiras, 15 - Campinas/SP', 
            recipient_phone: '019985463251', distance: 7, delivery_time: nil, status: :pending ,total_cost:nil)
            Cost.create!(category: :weight, minimum:6,maximum:8,unit_price:5, transportation_modal:transportation_modal)
            calculation = Calculation.create!(transportation_modal:transportation_modal, service_order: service_order)
    ...
    context 'distance_cost' do
        ...
        it 'return nil when distance cost does not meet the service order' do
            ...
            recipient_name: 'Maria Carvalho', recipient_address: 'Rua das Laranjeiras, 15 - Campinas/SP', 
            recipient_phone: '019985463251', distance: 7, delivery_time: nil, status: :pending ,total_cost:nil)
            Cost.create!(category: :distance, minimum:8, maximum:10,unit_price:3, transportation_modal:transportation_modal)
            calculation = Calculation.create!(transportation_modal:transportation_modal, service_order: service_order)
    ...
    context 'time' do
        ...
        it 'return nil when timescale does not meet the service order' do
            ...
            recipient_name: 'Maria Carvalho', recipient_address: 'Rua das Laranjeiras, 15 - Campinas/SP', 
            recipient_phone: '019985463251', distance: 7, delivery_time: nil, status: :pending ,total_cost:nil)
            Timescale.create!(min_distance:8,max_distance:10,deadline:24,transportation_modal:transportation_modal)
            calculation = Calculation.create!(transportation_modal:transportation_modal, service_order: service_order)
