...
describe 'Usuário busca por um pedido' do
  it 'e encontra um pedido em entrega' do
    ...
    transportation_modal = TransportationModal.create!(name: 'Bicicleta', max_distance: 10, min_distance: 1,
                                                       ...
                                                       status: :active)
    vehicle = Vehicle.create!(license_plate: 'HUIK-5232', model: 'City Tour', brand: 'Caloi',
                              max_weight: '5',
  ...
  it 'e encontra um pedido entregue no prazo' do
    ...
    service_order = ServiceOrder.create!(pickup_address: 'Rua das Amoras, 52 - Campinas/SP',
                                         ...
                                         recipient_address: 'Rua das Laranjeiras, 15 - Campinas/SP',
                                         recipient_phone: '019985463251', distance: 7, delivery_time: 24,
                                         status: :ontime, delivery_date: Time.zone.today, vehicle:)
  ...
  it 'e encontra um pedido entregue em atraso' do
    ...
    service_order = ServiceOrder.create!(pickup_address: 'Rua das Amoras, 52 - Campinas/SP',
                                         ...
                                         recipient_address: 'Rua das Laranjeiras, 15 - Campinas/SP',
                                         recipient_phone: '019985463251', distance: 7, delivery_time: 24,
                                         status: :delayed, vehicle:,
                                         delivery_date: Time.zone.today, delay_reason: 'Enchentes na região')
