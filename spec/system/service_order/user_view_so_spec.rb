...
describe 'Usuario vê a lista de ordens de serviço' do
    ...
    it 'e filtra somente pendentes' do
        ...
        other_service_order = ServiceOrder.create!(pickup_address: 'R. Silveira Neto, 144 - Água Verde, Curitiba - PR, 80620-410',
            ...
            recipient_phone: '015975485638', distance: 300, status: :intransit)
