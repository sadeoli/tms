...
describe 'Usuário vê uma ordem de serviço' do
  it 'e não vê modalidades desativadas' do
    ...
    transportation_modal = TransportationModal.create!(name: 'Bicicleta', max_distance: 10, min_distance: 1,
                                                       ...
                                                       status: :inactive)
    transportation_modal2 = TransportationModal.create!(name: 'Motocicleta', max_distance: 100,
                                                        min_distance: 11, max_weight: 20, min_weight: 0,
                                                        flat_rate: 15, status: :active)
    ...
    service_order = ServiceOrder.create!(pickup_address: 'Rua das Amoras, 52 - Campinas/SP',
                                         ...
                                         recipient_phone: '019985463251', distance: 12, delivery_time: nil,
    ...
    Cost.create!(category: :distance, minimum: 11, maximum: 15, unit_price: 3,
                 transportation_modal: transportation_modal2)
    Cost.create!(category: :weight, minimum: 0, maximum: 8, unit_price: 5,
                 transportation_modal: transportation_modal2)
    Timescale.create!(min_distance: 11, max_distance: 40, deadline: 24,
                      transportation_modal: transportation_modal2)
