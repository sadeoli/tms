...
describe 'Usuário vê o resultado da calculadora' do
    it 'dentro de uma ordem de serviço' do
        # Arrange
    ...
    it 'e não há modalidade que atende' do
        ...
        vehicle = Vehicle.create!(license_plate: 'HUIK-5232', model: 'City Tour', brand: 'Caloi', max_weight: '5', 
        manufacture_year: '2015', transportation_modal:transportation_modal, status: :active)
        service_order = ServiceOrder.create!(pickup_addres: 'Rua Senado, 52 - Vitória/ES', product_code: 'PPS524060', weight: 25, width: 20, height: 40, depth: 50, 
