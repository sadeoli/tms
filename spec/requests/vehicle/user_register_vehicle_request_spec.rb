...
describe 'Usuário cria um veículo' do
  ...
  context 'create' do
    it 'e é regular' do
      ...
      # Act
      login_as(user)
      post(vehicles_path, params: { vehicle: { license_plate: 'HUIK-5232', model: 'City Tour', brand: 'Caloi',
                                               max_weight: '5', manufacture_year: '2015',
                                               transportation_modal_id: transportation_modal[:id], status: :active } })
